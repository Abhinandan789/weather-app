    ...
    return (
        ...
        <div className="cardm">
            <div className="card">
                ...
                <div className="main">{Math.round(temp)}°C</div>
          ...
          OFQwNToxNToyNiswMDowMIjQlfwAAAAASUVORK5CYII=" />
                        ...
                        <div className="realfeeltext">Real Feel<br />{Math.round(feels_like)}°C</div>
                    </div>
          ...
          Ut8AAAAASUVORK5CYII=" />
                        ...
                        <div className="pressuretext">Pressure<br />{pressure}hPa</div>
                    </div>
